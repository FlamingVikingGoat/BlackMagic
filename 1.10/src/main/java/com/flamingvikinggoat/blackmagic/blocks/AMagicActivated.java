...
import com.flamingvikinggoat.blackmagic.blocks.item.IMetaBlockName;
...
public abstract class AMagicActivated extends BlockBase implements IMetaBlockName{
    public static final PropertyEnum TYPE = PropertyEnum.create("type", BlackEnums.SacrificialStatus.class);

    public AMagicActivated(String name, Material material, int index){
